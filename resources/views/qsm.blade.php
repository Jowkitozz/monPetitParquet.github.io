...
<head>
	...
	<script src="https://kit.fontawesome.com/29a81ce1a8.js" crossorigin="anonymous"></script>
...
<body>
		...
		<div class="container">
			<div class="row d-flex align-items-center justify-content-center">
				<div class="about-content col-lg-12">
					...
					<p class="text-white link-nav"><a href="index.html">Accueil</a> <span
							class="lnr lnr-arrow-right"></span> <a href="services.html">qui sommes nous ? </a></p>
				</div>
			</div>
		</div>
	</section>
			...
			<div class="row d-flex justify-content-center">
				<div class="menu-content  col-lg-7">
					<div class="title text-center">
						<h1 class="mb-10">L'histoire de notre application</h1>
						<p>L'application MPP a été crée par 2 jeunes plutôt tchatcheur en 2019 #CORONAVIRUS.</p>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-12 col-md-6">
					<div class="single-services">
						...
						<p>
							L'application MonPetitParquet, est directement inspiré de l'application MonPetitGazon.
							Application permettant de gérer une équipe de football et dans le même concept que notre
	...
	<section class="facts-area section-gap" id="facts-area">
		<div class="container">
			<div class="row">
				<i class="fas fa-basketball-ball fa-5x" style="margin-left:540px;color:white;"></i>
				<p style="color:white;margin-top: 10px;">L'application MonPetitParquet permettant une association entre
					le basketball
					et la gestion d'équipe afin de ne pas passer pour un looser auprès de ces copains quand on perds une
					ligue.
					MPP regroupe un ensemble d'élément interactif et sociable permettant la conformité de l'application
				</p>
			</div>
		</div>
	</section>
