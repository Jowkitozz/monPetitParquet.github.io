			...
			<div class="row">
				...
				<div class="col-lg-4 d-flex flex-column address-wrap">
					...
					<div class="single-contact-address d-flex flex-row">
						...
						<div class="contact-details">
							<h5>06 13 12 11 10</h5>
							<p>Lun Au Dim de 9h à 18h</p>
						</div>
					</div>
					<div class="single-contact-address d-flex flex-row">
						<div class="icon">
						...
						<div class="contact-details">
							<h5>MPP@gmail.com</h5>
							<p>Envoie nous un petit panier doumé !</p>
						</div>
					</div>
				</div>
				<div class="col-lg-8">
						...
						<div class="row">
							<div class="col-lg-6 form-group">
								<input name="name" placeholder="Nom" onfocus="this.placeholder = ''"
									onblur="this.placeholder = 'Nom'" class="common-input mb-20 form-control"
									required="" type="text">
								...
								<input name="subject" placeholder="Sujet" onfocus="this.placeholder = ''"
									onblur="this.placeholder = 'Sujet'" class="common-input mb-20 form-control"
									required="" type="text">
							</div>
							<div class="col-lg-6 form-group">
							...
							<div class="col-lg-12">
								...
								<button class="genric-btn primary" style="float: right;">Envoyé message</button>
							</div>
						</div>
					</form>
				</div>
