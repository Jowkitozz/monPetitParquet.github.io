			...
			<div class="row d-flex align-items-center justify-content-center">
				<div class="about-content col-lg-12">
					...
					<p class="text-white link-nav"><a href="index.html">Accueil </a> <span
							class="lnr lnr-arrow-right"></span> <a href="about.html">Actualités</a></p>
				</div>
			</div>
		</div>
	</section>
		...
		<div class="container">
			<div class="row align-items-center justify-content-between">
				<div class="col-lg-6 col-md-6 home-about-left">
					<img class="img-fluid" src="img/lebron.jpg" alt="">
				</div>
				<div class="col-lg-5 col-md-6 home-about-right">
					<h6>Actualités</h6>
					<h1 class="text-uppercase">Lebron James</h1>
					<p>
						LeBron James, né le 30 décembre 1984 à Akron (Ohio), est un joueur professionnel américain de
						basket-ball. Il évolue actuellement aux Lakers de Los Angeles en National Basketball Association
						(NBA). Mesurant 2,03 m et pesant 113 kg, il a la possibilité de jouer à la fois ailier et ailier
						fort. Il est considéré comme le meilleur ailier et l'un des meilleurs joueurs de l'histoire de
						la NBA. Il est surnommé King James (le Roi James) ou The Chosen One (L'Élu).
					</p>
